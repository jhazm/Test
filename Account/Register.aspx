<%@ Page Title="Register | Volleyball Playas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="VolleyballPlayas.WebUI.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:DropDownList ID="Region" CssClass="form-control"  runat="server">
                    <asp:ListItem Value="">select</asp:ListItem>
                    <asp:ListItem Value="Los Angeles / Orange County">Los Angeles / Orange County</asp:ListItem>
                    <asp:ListItem Value="San Diego">San Diego</asp:ListItem>
                    <asp:ListItem Value="Northern California">Northern California</asp:ListItem> 
                </asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Region"
                    CssClass="text-danger" ErrorMessage="Region is required." />
            </div>
        </div>
